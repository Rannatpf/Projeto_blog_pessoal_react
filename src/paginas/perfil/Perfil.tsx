...
import loginLogo from '../../assets/perfil.png'
import { toastAlerta } from '../../util/toastAlerta'
import perfilPadrao from '../../assets/perfil-padrao.png';
...
function Perfil() {
  ...
  return (
    <div className='container mx-auto mt-4 rounded-2xl overflow-hidden'>
      ...
      <div className="relative mt-[-6rem] h-72 flex flex-col bg-purple-700 text-white text-2xl items-center justify-center">
